...
class global.ViewDescriber
	...
	step: () ->
		...
		m = m.concat @compare(@curstate.mobs, @prestate.mobs, (m) -> return m.monsterType.appearsMsg)
		m = m.concat @compare(@curstate.items, @prestate.items, (m) -> return m.itemType.appearsMsg)
